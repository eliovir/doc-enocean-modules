...
La prise Enocean® SmartPlug permet de commander à distance vos appareils électrique tout en mesurant l'énergie consommée !
...
Actuellement, les boutons du widget ne marchent pas dans le Dashboard car l'info Etat reste bloquée sur 1 ce qui va empêcher le va et vient.
...
Une prochaine mise à jour devrait corriger ce problème...
